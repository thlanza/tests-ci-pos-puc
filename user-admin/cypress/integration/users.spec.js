describe("Gestão de usuários", () => {
    ...
    it("Editar um usuário", () => {
        cy.request('POST', 'http://localhost:4000/users', {
            ...
            cy.get('#name').clear().type('Thiago Lanza')
            cy.get('#email').clear().type('thlanza@gmail.com')
            ...
            cy.visit(`#/users/${response.body.id}`)
            cy.get('#name').should('have.value', 'Thiago Lanza')
            cy.get('#email').should('have.value', 'thlanza@gmail.com')
            })
        })
